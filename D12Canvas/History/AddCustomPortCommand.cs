...
// ADR 0005/ticket 55: adding a custom port to an instance is its own undoable gesture, parallel to
// AddEntityCommand/AddEdgeCommand. Undo removes exactly the port that was added (by its own Id, not
// just "the last one"), since further ports may have been added to the same instance since.
