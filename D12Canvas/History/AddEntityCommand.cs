...
// ADR 0007: creation, undoable. The instance already carries its full state (id, bounds, props),
// so undo/redo just removes/re-adds the same reference - no snapshot needed.
