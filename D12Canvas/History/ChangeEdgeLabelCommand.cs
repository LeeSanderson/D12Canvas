...
// ADR 0005/ticket 53: adding, replacing, or removing an edge's embedded Label is one undoable
// gesture - the Edge counterpart to ChangeEdgeStyleCommand, swapping the whole ComponentInstance
// reference (or null) rather than one of its fields. Editing an existing label's own Props (its
// text) is a separate gesture and reuses the generic MutateEntityCommand instead (see
