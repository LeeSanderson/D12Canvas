...
// Promotes an ad-hoc multi-selection into a persistent board entity. MemberIds is a reference list
// held by the group, not a back-pointer on members (CONTEXT.md) - membership can
