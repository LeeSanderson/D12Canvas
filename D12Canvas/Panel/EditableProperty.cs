...
// builder override (ticket 58). SharedTag is only populated when the author has explicitly opted
// this property into cross-type matching (ticket 59) - null means it never participates in a
// cross-type multi-selection's merged view, regardless of its name or Kind.
