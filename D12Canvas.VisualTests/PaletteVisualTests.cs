...
// Screenshot-diff baseline for the rendered palette (ticket 26). Any later ticket that renders a
// new visual state on canvas chrome should add a case here alongside its own.
