...
// Ticket 59: a second, distinct component type for PropertyPanelTests' cross-type multi-select
// coverage. AccentColor carries the same SharedTag ("color") as PanelTestProps.Tint, with a
// matching EditorKind/CLR type, so SharedPropertyValidator accepts the pair at registration; Note
// carries no tag at all, standing in for a property that must NOT leak into a cross-type selection.
