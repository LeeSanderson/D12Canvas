...
// Ticket 59: a minimal fixture solely for D12CanvasOptionsTests' SharedTag-CLR-type-mismatch throw
// test - carries the same SharedTag ("color") and EditorKind (Color) as PanelTestProps.Tint, but a
